...
public class App {
    ...
    public static void main(String[] args) {
        ...
        programAST.code().codeline().forEach(clCtx -> {
            WaterfallParser.VariableDeclarationContext variableDeclarationContext = clCtx.variableDeclaration();
            System.out.println(variableDeclarationContext.variableType().ID().getText());
            System.out.println(variableDeclarationContext.variableName().ID().getText());
            System.out.println(variableDeclarationContext.variableValue().INT_LITERAL());
            System.out.println(variableDeclarationContext.variableValue().DEC_LITERAL());
            System.out.println();
        });
    }
}
