...
- **Supporting practices** (also non-negotiable):
  - **Tests Aaron writes, not the AI writes** for contract tests. AI writes implementation tests inside the contract Aaron specifies. EARS-notation acceptance criteria translate directly to Aaron-authored tests.
